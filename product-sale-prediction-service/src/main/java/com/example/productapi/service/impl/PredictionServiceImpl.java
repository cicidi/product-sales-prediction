...
public class PredictionServiceImpl implements PredictionService {
    ...
    @Autowired
    public PredictionServiceImpl(ProductRepository productRepository, OrderRepository orderRepository, PythonPredictionClient pythonPredictionClient) {
    ...
    @Override
    public Predications predictSales(String productId, String sellerId, Double priceToSale,
    ...
    /**
     * Prepare features for prediction using the specific features required by the Python prediction service
     * Features: product_id, seller_id, sale_price, original_price, is_holiday, is_weekend, day_of_week, day_of_month, month, lag_1, lag_7, lag_30
     */
    private Map<String, Object> prepareFeatures(String productId, String sellerId, Double priceToSale, LocalDate predictionDate,
        ...
        features.put("day_of_week", predictionDate.getDayOfWeek().getValue() - 1); // Python weekday: Monday=0, Sunday=6
     ...
     */
    private Map<String, Double> calculateLagFeatures(List<Order> historicalOrders, LocalDate predictionDate) {
    ...
    private List<Order> getHistoricalOrders(String productId, String sellerId, LocalDate startDate) {
        ...
        return orderRepository.findBySellerIdAndProductIdAndTimestampAfter(sellerId, productId, cutoffDate);
    }
