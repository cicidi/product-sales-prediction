...
@Tag(name = "MCP", description = "Model-Centric Protocol API - Provides tool invocation interface for Large Language Models (LLMs), supporting Product, Orders,  Sales Analysis and Prediction functions")
